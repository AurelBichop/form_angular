...
@Component({
  ...
  template: `<h1>Découverte Angular</h1>
    ...
    <a
      confirm
      confirm-message="Tu es sure de toi !"
    ...
    >
      ...
      consectetur deserunt, asperiores iure cum.
    </p>
    ...
    <p>
      ...
      asperiores. Rerum ipsam eius sit error, molestias omnis. Et ipsum alias,
      eos voluptas officia deserunt.
    </p>

    <p>
      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sapiente,
      impedit. Distinctio numquam ipsum magnam magni quibusdam consectetur
      voluptate illo. Laboriosam atque sed iure? Voluptate, officiis!
    </p> `,
  styles: [],
})
export class AppComponent {
  ...
  onColorChange(color: string) {
    console.log('La Couleur Change en:' + color);
  }
}
